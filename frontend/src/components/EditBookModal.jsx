    ...
    <AnimatePresence>
      {open && book && (
        <>
          ...
          >
            <div className="bg-white  shadow-2xl w-full max-w-md max-h-[90vh] overflow-y-auto pointer-events-auto">
                  ...
                  <>
                    ...
                    <label className="block">
                      ...
                      <input value={form.isbn || ''} onChange={e => set('isbn', e.target.value)}
                        className="mt-1 w-full border border-gray-200  px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-300 font-mono" />
                    </label>
